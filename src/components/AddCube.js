...
const AddCube = ({ isOpen, onClose, showCubes }) => {
  ...
  const addCube = () => {
    ...
    axios
      .post(
        "http://labmanagementsystemapi-production.up.railway.app/api/cube/store",
        addedCube,
        {
          headers: {
  ...
  return (
    <Modal isOpen={isOpen} onClose={closeModal}>
      ...
      <ModalContent
        ...
        overflow="scroll"
      >
        <ModalHeader>اضافة فحص مكعبات جديد</ModalHeader>
        ...
        <ModalFooter>
          ...
          <Button colorScheme="blue" ml={3} onClick={addCube}>
            اضافة
          </Button>
        </ModalFooter>
      </ModalContent>
